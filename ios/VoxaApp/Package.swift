...
let package = Package(
    ...
    products: [
        ...
        .library(name: "VoxaPractice", targets: ["VoxaPractice"]),
    ...
    targets: [
        ...
        .target(name: "VoxaPractice"),
        .target(name: "VoxaNetworking", dependencies: ["VoxaDomain", "VoxaAuth", "VoxaOnboarding", "VoxaRealtime", "VoxaProfiles", "VoxaPractice"]),
        ...
        .target(name: "VoxaProfiles", dependencies: ["VoxaDomain", "VoxaOnboarding", "VoxaRealtime"]),
        .target(
        ...
        .target(name: "VoxaHome", dependencies: ["VoxaDomain", "VoxaRealtime", "VoxaPractice"]),
        .target(
            name: "VoxaAppShell",
        ...
        .testTarget(name: "VoxaNetworkingTests", dependencies: ["VoxaNetworking", "VoxaProfiles", "VoxaPractice"]),
        ...
        .testTarget(name: "VoxaHomeTests", dependencies: ["VoxaHome", "VoxaPractice"]),
