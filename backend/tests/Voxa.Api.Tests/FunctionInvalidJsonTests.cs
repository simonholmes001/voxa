...
public sealed class FunctionInvalidJsonTests
{
    ...
    private sealed class StubLearningSessionCompletionService : ILearningSessionCompletionService
    {
    ...
    private sealed class StubLearnerPlanService : ILearnerPlanService
    {
    ...
    private sealed class StubDebriefService : IDebriefService
    {
